...
function MainLayout({
  ...
  const copy = {
    ko: {
      ...
      meditationRoom: '묵상실',
      meditationText: '오늘 본문을 읽고 마음에 남는 문장, 요약, 결단과 기도를 차분히 정리합니다.',
    },
    de: {
      eyebrow: 'Quiet Time Companion',
      ...
      meditationRoom: 'Andachtsraum',
      meditationText: 'Lies den heutigen Text und halte Gedanken, Anwendung und Gebet ruhig fest.',
    },
  }[uiLanguage || 'ko'];
  ...
  return (
    <div className="container sanctuary-shell">
      ...
      <section id="meditation-room" className="room-section">
        <div className="room-heading">
          <p className="eyebrow">{copy.meditationRoom}</p>
          <h2>{copy.meditationRoom}</h2>
          <p>{copy.meditationText}</p>
        </div>
        <Search
